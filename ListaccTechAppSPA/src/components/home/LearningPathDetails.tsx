...
const LearningPathDetails = () => {
  ...
  return (
    <div className=" pt-10 p-10 w-full flex flex-col dark:text-zink-100 gap-8 justify-center items-center ">
      <h1 className="text-4xl dark:text-zinc-100 font-bold text-center">
        {" "}
        Learning <span className="text-orange-500">Path </span>
        {Id}
      </h1>
      <div className="flex flex-col w-11/12 md:w-3/5 items-center gap-8">
        <p className="text-lg dark:text-zinc-100 text-gray-500">
        ...
        <div className="flex flex-col dark:text-zinc-100 dark:bg-gray-800 w-full shadow-md bg-white p-7 rounded gap-6 ">
        <h2 className="border-b-2 text-2xl p-5 font-extrabold"> HTML</h2>
          <ul className="space-y-5 text-lg">
            <li className="hover:bg-gray-100 dark:hover:bg-gray-700 p-5 rounded-md">
              {" "}
