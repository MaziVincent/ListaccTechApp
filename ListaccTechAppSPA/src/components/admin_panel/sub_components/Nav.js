...
const Nav = () => {
  ...
  return (
    ...
    <aside
      className=' w-full h-full bg-gray-100 md:block dark:bg-gray-600 z-10 flex  '
      aria-label='Sidebar'
    >
      <div className='overflow-y-auto py-4  max-h-full'>
        ...
        <ul className='space-y-2 w-full flex flex-col justify-center items-center '>
          <li className='w-full'>
            <Link
              to='/admin'
              className='flex justify-center border-b-2 items-center p-2 text-base font-normal text-gray-400 hover:text-[#000] rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'
            >
              <div className='flex items-center text-gray-600 dark:text-zinc-100 justify-start gap-1'>
