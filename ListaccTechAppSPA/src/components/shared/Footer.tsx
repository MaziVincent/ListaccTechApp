  ...
  return (
   ...
   <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900 w-full ">
    <div className="md:flex md:justify-between ">
        <div className="mb-6 ml-3 md:mb-0">
            <a href="/Home" className="flex items-center">
                <img src={logo} className="mr-3 h-10 sm:h-10" alt="listacc Logo" />
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://Listacc.com/" className="hover:underline">Listacc Ltd ™</a>. All Rights Reserved.
        </span>
